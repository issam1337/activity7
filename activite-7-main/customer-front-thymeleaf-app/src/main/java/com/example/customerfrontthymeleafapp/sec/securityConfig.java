...
public class securityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        return http
                ...
                .authorizeHttpRequests(ar->ar.requestMatchers("/","/oauth2Login/**","/webjars/**","/h2-console/**").permitAll())//pour ceci ca necessite pas une auth pour les autres oui
    ...
    //le bean accede a jwt et cherche ou se trouve les roles
    @Bean
